...
class Matcher:
    ...
    def _scores_to_accuracy(m, X, y):
        ...
        predictions = predictions.values.reshape(len(predictions), 1)
        # print(predictions.shape)
        # print(0)
        # print('\n y_shape', y.shape)
        # print('p_shape', predictions.shape)
        # print(1)
        preds = [1.0 if i >= .5 else 0.0 for i in predictions]
        # print(2)
        ...
        # res = res * 1.0 / len(y)
        # print(2.3)        
        result =  (y.values == preds).sum() * 1.0 / len(y)
        # print(3)
